...
const sms = (conn, m) => {
    ...
    if (m.message) {
        ...
        if (m.msg) {
            ...
            const quotedMention = m.msg.contextInfo !== undefined ? m.msg.contextInfo.participant : '';
            const tagMention = m.msg.contextInfo !== undefined ? m.msg.contextInfo.mentionedJid : [];
            ...
            if (m.quoted) {
                ...
                const quoted_quotedMention = m.quoted.msg.contextInfo !== undefined ? m.quoted.msg.contextInfo.participant : '';
                const quoted_tagMention = m.quoted.msg.contextInfo !== undefined ? m.quoted.msg.contextInfo.mentionedJid : [];
